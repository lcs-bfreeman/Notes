...
let David = "David Jeff"
let Good = "Bad"

let stuff = [David,Good]
...
//60 w3c
//operators
// In swift there are many different operators such as adition(+), subtraction(-), division(/), multiplication(*) and the remainder(%)
let firstScore = 12
let secondScore = 4
...
// This all basically means you can have multiple layers of operations and arrays for as long as you want
